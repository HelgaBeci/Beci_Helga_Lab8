...
namespace Beci_Helga_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        
 public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Beci_Helga_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Beci_Helga_Lab8Context context,
